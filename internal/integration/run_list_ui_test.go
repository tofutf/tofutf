...
func TestIntegration_RunListUI(t *testing.T) {
	...
	tfConfig := newRootModule(t, daemon.System.Hostname(), ws.Organization.Name, ws.Name)

	var runListingAfter []*cdp.Node
	browser.Run(t, ctx, chromedp.Tasks{
		// navigate to workspace page
		chromedp.Navigate(workspaceURL(daemon.System.Hostname(), ws.Organization.Name, ws.Name)),
