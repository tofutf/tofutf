...
func TestEventHandler(t *testing.T) {
	tests := []struct {
		...
		// 		CommitURL:      "https://bitbucket.tofutf.io/projects/tft/repos/terraform-tofutf-test/commits/07101e82c4f525d5f697111f0690bdd0ff40a865",
		// 		Action:         vcs.ActionCreated,
		// 		SenderUsername: "robbert229",
		// 		// SenderAvatarURL: "https://avatars.githubusercontent.com/u/75728?v=4",
		// 		// SenderHTMLURL:   "https://github.com/leg100",
		// 	},
		// 	false,
